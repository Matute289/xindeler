...
//////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        bow_burning_heartseeker: "voxygen.element.skills.bow.burning_heartseeker",
        bow_freezing_heartseeker: "voxygen.element.skills.bow.freezing_heartseeker",
        bow_poison_heartseeker: "voxygen.element.skills.bow.poison_heartseeker",
        bow_lightning_heartseeker: "voxygen.element.skills.bow.lightning_heartseeker",
        bow_hawkstrike: "voxygen.element.skills.bow.hawkstrike",
        bow_burning_hawkstrike: "voxygen.element.skills.bow.burning_hawkstrike",
        bow_freezing_hawkstrike: "voxygen.element.skills.bow.freezing_hawkstrike",
        bow_poison_hawkstrike: "voxygen.element.skills.bow.poison_hawkstrike",
        bow_lightning_hawkstrike: "voxygen.element.skills.bow.lightning_hawkstrike",
        ...
        bow_thorn_stake: "voxygen.element.skills.bow.thorn_stake",
        bow_burning_thorn_stake: "voxygen.element.skills.bow.burning_thorn_stake",
        bow_freezing_thorn_stake: "voxygen.element.skills.bow.freezing_thorn_stake",
        bow_poison_thorn_stake: "voxygen.element.skills.bow.poison_thorn_stake",
        bow_lightning_thorn_stake: "voxygen.element.skills.bow.lightning_thorn_stake",
        // Skilltree Icons
        ...
        // Debuffs
        // BL-67: game-icons.net art for the full buff/debuff set (foreground on a
        // category-coloured shape). asleep = the hand-drawn "Zzz"; the 11 names that
        // already existed (buff_fury/reckless/flame/frigid/lifesteal/resilience/
        // sunderer/defiance/tenacity/heartseeker, debuff_chilled) keep their entry —
        // their PNGs were overwritten in place with the new art.
        debuff_asleep: "voxygen.element.de_buffs.debuff_asleep",
        debuff_blinded: "voxygen.element.de_buffs.debuff_blinded",
        debuff_terrified: "voxygen.element.de_buffs.debuff_terrified",
        debuff_anchored: "voxygen.element.de_buffs.debuff_anchored",
        debuff_bleeding_mark: "voxygen.element.de_buffs.debuff_bleeding_mark",
        debuff_hollowtouched: "voxygen.element.de_buffs.debuff_hollowtouched",
        debuff_difficult_terrain: "voxygen.element.de_buffs.debuff_difficult_terrain",
        debuff_antimagic: "voxygen.element.de_buffs.debuff_antimagic",
        debuff_charmed: "voxygen.element.de_buffs.debuff_charmed",
        debuff_burning: "voxygen.element.de_buffs.debuff_burning",
        debuff_cursed: "voxygen.element.de_buffs.debuff_cursed",
        debuff_crippled: "voxygen.element.de_buffs.debuff_crippled",
        debuff_frozen: "voxygen.element.de_buffs.debuff_frozen",
        debuff_wet: "voxygen.element.de_buffs.debuff_wet",
        debuff_ensnared: "voxygen.element.de_buffs.debuff_ensnared",
        debuff_poisoned: "voxygen.element.de_buffs.debuff_poisoned",
        debuff_parried: "voxygen.element.de_buffs.debuff_parried",
        debuff_potion_sickness: "voxygen.element.de_buffs.debuff_potion_sickness",
        debuff_heatstroke: "voxygen.element.de_buffs.debuff_heatstroke",
        debuff_rooted: "voxygen.element.de_buffs.debuff_rooted",
        debuff_winded: "voxygen.element.de_buffs.debuff_winded",
        debuff_confused: "voxygen.element.de_buffs.debuff_confused",
        ...
        buff_potion: "voxygen.element.de_buffs.buff_potion",
        buff_agility: "voxygen.element.de_buffs.buff_agility",
        buff_resting_heal: "voxygen.element.de_buffs.buff_resting_heal",
        buff_frenzied: "voxygen.element.de_buffs.buff_frenzied",
        buff_energy_regen: "voxygen.element.de_buffs.buff_energy_regen",
        buff_combo_generation: "voxygen.element.de_buffs.buff_combo_generation",
        buff_increase_max_energy: "voxygen.element.de_buffs.buff_increase_max_energy",
        buff_increase_max_health: "voxygen.element.de_buffs.buff_increase_max_health",
        buff_invulnerability: "voxygen.element.de_buffs.buff_invulnerability",
        buff_protecting_ward: "voxygen.element.de_buffs.buff_protecting_ward",
        buff_hastened: "voxygen.element.de_buffs.buff_hastened",
        buff_fortitude: "voxygen.element.de_buffs.buff_fortitude",
        buff_imminent_critical: "voxygen.element.de_buffs.buff_imminent_critical",
        buff_berserk: "voxygen.element.de_buffs.buff_berserk",
        buff_scornful_taunt: "voxygen.element.de_buffs.buff_scornful_taunt",
        buff_owl_talon: "voxygen.element.de_buffs.buff_owl_talon",
        buff_heavy_nock: "voxygen.element.de_buffs.buff_heavy_nock",
        buff_eagle_eye: "voxygen.element.de_buffs.buff_eagle_eye",
