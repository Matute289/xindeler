...
| EM-5.16 | **Accessibility, UI scaling & i18n depth** — subtitles, reduced-flashing, scaling, full multi-language i18n | 🔵 **T56.43 (accessibility toggles + UI-scale surfacing + tutorial overlay; positional-sound subtitles deferred until EM-5.10b lands) + T56.44 (full Fluent i18n, hot-swap language switching) in progress.** | `tasks/56-bl82-phase5-ui-audio-parity-tasks.md` |
