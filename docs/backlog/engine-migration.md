...
| EM-3.11 **[M]** | In-game visual smoke (AO/TAA/fog/anims/perf vs old client) | 🔵 8 rounds of Matías live-playtest fixes so far (PRs #32/#34/#36/#37/#39/#40/#41): camera, tree/terrain color, far-mesh, perf (FixedUpdate + death-spiral hotfix), fog, ghost-hand/TAA, terrain black-frame, placeholder lighting. **Full findings log (root causes, evidence, per-round detail):** `docs/design/specs/2026-07-09-bl82-em311-findings-log.md`. Currently investigating round 9: diagonal-movement stutter + white flashes + black wall recurring (record3.mov, 2026-07-09). |
