...
| **3** | Voxel meshing, terrain & figures | 🔵 **in progress** — EM-3.1→3.9 done (PRs #7–#19): **real Xindeler terrain + entities + a controllable character + real animated `.vox` figures (quadruped/humanoid/birds) with a weapon + vegetation sprites & translucent water now render in Bevy**; EM-3.8d/3.9b/3.10/3.11 pending |
