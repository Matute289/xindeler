...
| EM-5.20 | **Full es-419 (Spanish, Latin American) i18n coverage** — decided to drop legacy `es` (Iberian Spanish) and make `es-419` the client's one Spanish locale; translated the ~1265 keys `es-419` was missing vs. `en` across 7 sequential PRs, then deleted `assets/voxygen/i18n/es/` and re-pointed every arbitrary-sample-locale test off it. | ✅ done (PRs #209–#217 + close-out) | `specs/2026-07-23-bl82-em520-es419-i18n-design.md`, `plans/2026-07-23-bl82-em520-es419-i18n-plan.md` |
