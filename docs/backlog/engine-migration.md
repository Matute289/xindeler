...
| **6** | Upstream-sync drills & hardening | 🔵 **EM-6.1 done** (PR #203, 184 commits merged, 43 conflicts resolved — see row for full findings). Remaining: EM-6.2 (drill #2, target <1 day routine), EM-6.3 (Bevy version-bump rehearsal), EM-6.4/6.5 (cutover retirement + perf review, sequenced after EM-5.13). |
