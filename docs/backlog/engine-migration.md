...
| **6** | Upstream-sync drills & hardening | 🔵 **EM-6.1 done** (PR #203, 184 commits merged, 43 conflicts resolved — see row for full findings). **EM-6.2 runbook written + EM-6.3 assessed** (no timed drill possible yet — empty upstream delta; no Bevy bump possible yet — 0.20 unreleased). Remaining: EM-6.4/6.5 (cutover retirement + perf review), both sequenced after EM-5.13. |
