...
| BL-32 | **Player parties up to 25** (raise group cap; key for RIDE events + Battle PITS) | Social | 4 | 3 | 3 | **10** | ✅ | DONE (PR #72): `max_player_group_size` default 6→25 (admin-tunable; group sys + HUD scale dynamically). specs/2026-06-22-parties-25. Pending: HUD layout polish at large parties, sync bandwidth, in-game smoke. Unblocks BL-42 |
...
| BL-33 | **Alignment system** (Good/Neutral/Evil × Lawful/Neutral/Chaotic for PCs & NPCs; enriches underworld/factions, feeds AURORA) | Systems/Sim | 3 | 3 | 4 | **8** | ⚪ | backlog-additions §BL-33 (feeds BL-15) |
