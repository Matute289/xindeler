...
| BL-33 | **Alignment system** (Good/Neutral/Evil × Lawful/Neutral/Chaotic for PCs & NPCs; enriches underworld/factions, feeds AURORA) | Systems/Sim | 3 | 3 | 4 | **8** | 🔵 | `comp::Ethos` (9-box scores; distinct from AI `comp::Alignment`). DONE: P1 sync + `/set_ethos` (#75); P2a PC persistence migration V72 (#76); P2b NPC assignment via EntityConfig+derive (#77); P3 PC deed-drift on kills (#78). specs/2026-06-22-alignment-system; tasks/18. Pending: char-creation alignment pick (voxygen UI — in-client iteration); AURORA-era = behavioural consequences + NPC drift + more deeds. feeds BL-15 |
