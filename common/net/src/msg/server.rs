...
/// [`xindeler_client_core::Client::client_type`] wants to emit login events.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// update the client.
///
/// See [`xindeler_client_core::UserNotification`] for the stripped down
/// version, which the client sends to the UI after removing (and using) any
