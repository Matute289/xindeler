// LIFT-COPY (BL-82 EM-3.1, Mapper C5-C7) from voxygen/src/render/mesh.rs @
// 6f9afd978c
//
// Divergences from the original:
// - `use super::Vertex` → `use super::vertex::Vertex` (portable trait, see
//   vertex.rs). Everything else is byte-identical to upstream.
