...
hud-settings-enable_poise_bar = Mostrar barra de equilibrio
...
hud-settings-use_prefixes = Usa prefijos SI para cantidades
...
hud-settings-keybind-helper =
    M1 para establecer
    M2 para restablecer
hud-settings-show_all_recipes = Mostrar Todas Las Recetas
hud-settings-use_health_prefixes = Usa prefijos SI para la barra de salud
hud-settings-minimap = Minimapa
hud-settings-minimap_scale = Escala
hud-settings-colored_player_marker = Marcador Coloreado de Jugador
hud-settings-lock_chat = Bloquear Tamaño/Posición de Chat
hud-settings-show_chat_timestamp = Mostrar Estampas de Tiempo en Chat
hud-settings-rain = Lluvia
hud-settings-rain_ambience = Ambiente de Lluvia
hud-settings-sfx_channels = Capacidad de Canal de Efectos de Sonido
hud-settings-sfx_channels_low = Bajo
hud-settings-sfx_channels_med = Medio
hud-settings-sfx_channels_high = Alto
hud-settings-gamepad = Mando
hud-settings-keyboard = Teclado
hud-settings-game_buttons = Botones de Juego
...
hud-settings-reduce_flashing = Reducir destellos
hud-settings-high_contrast_ui = Interfaz de alto contraste
