...
common-kind-modular_component = Componente modular
    .sword = Componente de Espada
    .axe = Componente de Hacha
    .hammer = Componente de Martillo
    .bow = Componente de Arco
    .staff = Componente de Bastón de Fuego
    .sceptre = Componente de Cetro
...
common-tool-throwable = Lanzable
...
common-kind-recipegroup = Recetas
