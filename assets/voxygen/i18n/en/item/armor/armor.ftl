...
armor-misc-ring-test_attunement_ring = Test Ring of Attunement
    .desc = Debug ring. Grants its power only while you are attuned to it.
armor-misc-ring-test_attunement_ring_2 = Test Ring of Attunement II
    .desc = Debug ring. Its protection is gated by attunement; its poise resilience is not.
