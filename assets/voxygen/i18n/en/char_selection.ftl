...
char_selection-wizard_step = Step { $step } of 5
char_selection-summary_name = Name: { $name }
char_selection-summary_race = Race: { $race }
char_selection-summary_class = Class: { $class }
char_selection-summary_alignment = Alignment: { $alignment }
